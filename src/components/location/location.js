        ...
        <div className="grid categorie-catalog">
            ...
            <div className="col-12 md:col-12">
                <div className="card">
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Detalles de ubicacion" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            <label htmlFor="name">Ubicacion</label>
                            <InputText id="ubicacion" value={product.ubicacion} onChange={(e) => onInputChange(e, 'ubicacion')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.ubicacion })} />
                            {submitted && !product.ubicacion && <small className="p-error">Ubicacion is required.</small>}
                        </div>
                        <div className="field">
...
export default React.memo(LocationTable, comparisonFn);
