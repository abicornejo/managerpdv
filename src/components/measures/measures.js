        ...
        <div className="grid categorie-catalog">
            ...
            <div className="col-12 md:col-12">
                <div className="card">
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div className='d-flex flex-wrap'>
                            <div className="field col-lg-4 col-12 p-fluid">
                                <div>Medida</div>
                                <InputText type="search" placeholder='Medida' name="medida" value={formik.values.medida} onChange={formik.handleChange}/>
                            </div>
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Detalles de medida" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            <label htmlFor="name">Medida</label>
                            <InputText id="marca" value={product.medida} onChange={(e) => onInputChange(e, 'medida')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.medida })} />
                            {submitted && !product.medida && <small className="p-error">medida is required.</small>}
                        </div>
                        <div className="field">
                    ...
                    <Dialog visible={deleteProductDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                        <div className="confirmation-content">
                            ...
                            {product && <span>Are you sure you want to delete <b>{product.medida}</b>?</span>}
                        </div>
                    </Dialog>
                </div>
            </div>
