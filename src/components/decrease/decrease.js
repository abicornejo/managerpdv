...
const DecreaseTable = () => {
    ...
    const [products, setProducts] = useState(merma);
        ...
        <div className="grid categorie-catalog">
            ...
            <div className="col-12 md:col-12">
                <div className="card">
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div className='d-flex flex-wrap'>
                            <div className="field col-lg-4 col-12 p-fluid">
                                <div>Producto</div>
                                <InputText type="search" placeholder='Ubicacion' name="nombre" value={formik.values.nombre} onChange={formik.handleChange}/>
                            </div>
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Detalles de merma" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            <label>Fecha</label>
                            <InputText value={product.fecha} onChange={(e) => onInputChange(e, 'fecha')} required autoFocus/>
                        </div>
                        <div className="field">
                            <label htmlFor="name">Producto</label>
                            <InputText id="name" value={product.producto} onChange={(e) => onInputChange(e, 'producto')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.producto })} />
                            {submitted && !product.producto && <small className="p-error">Producto is required.</small>}
                        </div>
                        <div className="field">
                            <label>Cantidad</label>
                            <InputNumber value={product.cantidad} onChange={(e) => onInputNumberChange(e, 'cantidad')} required autoFocus/>
                        </div>
                        <div className="field">
