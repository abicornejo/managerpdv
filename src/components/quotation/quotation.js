...
const QuotationTable = () => {
    const location = [
        {fecha:'14/07/2022', cliente:'Carlos', comprobante: 'Factura', impuesto: '16.0 %', total: 0, estatus:'Activo'}
    ];
            ...
            <div className="col-12 md:col-12">
                <div className="card">
                    <div className=' header-content'>
                        <h5>Catalogo de Cotizaciones</h5>
                    </div>
                    <form onSubmit={formik.handleSubmit}>
                        <div className='d-flex flex-wrap'>
                            <div className="field col-lg-4 col-12 p-fluid">
                                <div htmlFor="name1">Clientes</div>
                                <Dropdown placeholder='--Seleccione--' name="categoria" value={formik.values.clientes} onChange={formik.handleChange} /*options={countries} optionLabel="name"*//>
                            </div>
                            <div className="field col-lg-4 col-12 p-fluid">
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Alta de cotizacion" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            <label htmlFor="name">Cliente</label>
                            <Dropdown id="cliente" name='cliente' value={product.cliente} onChange={(e) => onCategoryChange(e, 'cliente')} required  optionLabel='name'/>
                        </div>
                        <div className="field">
                            <label htmlFor="description">Fecha Cotizacion</label>
                            <Calendar id="basic" value={date1} onChange={(e) => setDate1(e.value)} />                        
                            </div>
                        <div className="field">
                            <label htmlFor="estado">Producto</label>
                            <InputText id="ubicacion" value={product.producto} onChange={(e) => onInputChange(e, 'producto')} required autoFocus  />
                        </div>
                    </Dialog>
...
export default React.memo(QuotationTable, comparisonFn);
